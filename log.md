...
I really felt I lost momentum and motivation for days now.
It's due to lack of sufficient energy to do all that next to my duties at work and in private.
But also I'm missing a concreate direction or plan to what I want or can realistically achieve in the time available.
...
- researched mongodb a bit more
- created wishlist db
- grabbed a mongodb go program that lists the databases

![go-wishlist-available-databases.png](./assets/go-wishlist-available-databases.png)

**Thoughts**

Again I experienced a bad surprise when I had to learn that `--net=host` and `network_mode` in docker-compose *do not work* on Mac.

    ❯ docker-compose -f docker/docker-compose.yml up
    (root) Additional property network_mode is not allowed


What framework should I use, if any. gin, revel. beego sounds nice, too..
...
- worked on #istqb Technical Test Analyst flash cards
- more mongodb digging
- inserted first (mongodb) document through a go program 🤩

**Thoughts**

It’s nothing special really to have that insert working but I’m excited!

![go-wishlist-insert-first-item.gif](./assets/go-wishlist-insert-first-item.gif)

**Link to work:**

- Commit: [go-wishlist day 67-68](https://github.com/sebkraemer/go-wishlist/commit/d03159493b43307e51e00eb0972f5cf808c8f9c4)
...
- some thoughts about the REST API (👉README), including considering PUT/PATCH distinction
- experimenting with mongodbs autogenerated `_id`, not sure yet if/how to interface with api-facing IDs

Progress 😃

![go-wishlist-rest-api.jpeg](./assets/go-wishlist-rest-api.jpeg)

**Link to work:**

- Commit: [go-wishlist day 69](https://t.co/fn0mbRpmlF)
- Project: [go-wishlist submodule](./projects/go-wishlist)
...
setting up trivial web service and experimenting with serving pages using Go’s templating mechanism

I’ve used bootstrap so I’m almost one of you JS web design folks.

Well, not quite.. 😅

![day070-about-page.jpeg](./assets/day070-about-page.jpeg)

**Link to work:**

- Commit: [go-wishlist day 70](https://t.co/9RODwYXe5n)
- Project: [go-wishlist submodule](./projects/go-wishlist)
...
continuing with round-robining learning topics..

- finished creating uml class diagrams flash cards *(this is so much work!)*

![day071-uml-class-diagram-flashcard.png](./assets/day071-uml-class-diagram-flashcard.png)
...
- continuing with Golang templates

**Link to work:**

- Commit: [go-wishlist day 74](https://t.co/75acT7YpKU)
- Project: [go-wishlist submodule](./projects/go-wishlist)
...
- passing data to web page template
- (attempt at) using repository pattern I just learnt about
